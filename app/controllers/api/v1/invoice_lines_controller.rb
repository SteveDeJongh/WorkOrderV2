class Api::V1::InvoiceLinesController < ApplicationController
  ...
  private
    ...
    def invoice_line_params
      params.require(:invoice_line).permit(:invoice_id, :product_id, :discount_percentage, :price, :quantity, :line_total, :tax_rate, :line_tax)
    end
end
