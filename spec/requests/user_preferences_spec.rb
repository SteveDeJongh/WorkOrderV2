...
RSpec.describe "/user_preferences", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      UserPreference.create! valid_attributes
      get user_preferences_url, headers: valid_headers, as: :json
      ...
      it "creates a new UserPreference" do
        expect {
          post user_preferences_url,
               params: { user_preference: valid_attributes }, headers: valid_headers, as: :json
  ...
  describe "PATCH /update" do
    ...
    context "with invalid parameters" do
      it "renders a JSON response with errors for the user_preference" do
        user_preference = UserPreference.create! valid_attributes
        patch user_preference_url(user_preference),
              params: { user_preference: invalid_attributes }, headers: valid_headers, as: :json
        expect(response).to have_http_status(:unprocessable_entity)
  ...
  describe "DELETE /destroy" do
    it "destroys the requested user_preference" do
      user_preference = UserPreference.create! valid_attributes
      expect {
        delete user_preference_url(user_preference), headers: valid_headers, as: :json
      }.to change(UserPreference, :count).by(-1)
    end
  end
end
